...
const Products = () => {
    ...
    // Helper to render image URL safely
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <input value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} className="input-field w-full" required />
                                            </div>
                                            <div>
                                                <label className="label">Prix (DZD)</label>
                                                <input type="number" value={formData.price} onChange={e => setFormData({ ...formData, price: Number(e.target.value) })} className="input-field w-full" required />
                                            </div>
                                            <div>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <label className="label">Description courte (Liste)</label>
                                                <textarea value={formData.description} onChange={e => setFormData({ ...formData, description: e.target.value })} className="input-field w-full h-32 resize-none" placeholder="Une brève description pour la liste des produits..." />
                                            </div>
                                            <div className="flex items-center gap-3 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                                                ...
                                                />
                                                <label htmlFor="active" className="text-white font-medium select-none cursor-pointer">Produit Actif (Visible sur le site)</label>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                                    ...
                                                    {formData.features.map((feat, idx) => (
                                                        <div key={idx} className="flex items-center gap-4 p-3 bg-slate-900 border border-slate-800 rounded-lg group">
                                                            <div className="w-10 h-10 bg-slate-800 rounded flex items-center justify-center text-blue-400">
                                                                {/* We can't render dynamic icons easily without a map, so just show generic or text */}
                                                                <List size={20} />
                                                            </div>
                                                            <div className="flex-1">
